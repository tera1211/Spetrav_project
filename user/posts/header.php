...
$get_state=$state->display_all_states();
$get_city=$city->display_all_cities();
$get_place=$place->display_all_places();
?>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-6 col-xl-2">
              <h1 class="mb-0"><a href="list.php" class="text-black h2 mb-0">SPETRAV</a></h1>
            </div>

...
$get_post_by_state=null;
if(empty($category_id)){
    $get_post_by_state=$post->get_post_by_state($state_id);
}else{
    $get_post_by_state=$post->get_post_by_country_state_category($country_id,$state_id,$category_id);
}
?>

<?php if($get_post_by_state==TRUE):?>
<?php foreach($get_post_by_state as $key=>$values):?>
<div class="card my-4">

...
$get_post_by_city=null;
if(empty($category_id)){
    $get_post_by_city=$post->get_post_by_city($city_id);
}else{
    $get_post_by_city=$post->get_post_by_country_state_city_category($country_id,$state_id,$city_id,$category_id);
}
?>

<?php if($get_post_by_country==TRUE):?>
<?php foreach($get_post_by_city as $key=>$values):?>
<div class="card my-4">
